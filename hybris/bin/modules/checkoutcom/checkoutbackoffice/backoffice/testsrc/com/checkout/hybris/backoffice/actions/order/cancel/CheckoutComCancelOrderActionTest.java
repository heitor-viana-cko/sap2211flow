...
public class CheckoutComCancelOrderActionTest {
    ...
    @InjectMocks
    private CheckoutComCancelOrderAction testObj = new CheckoutComCancelOrderAction() {
        @Override
    ...
    public void setUp() {
        ...
        when(orderModelMock.getStatus()).thenReturn(OrderStatus.AUTHORIZATION_PENDING);
