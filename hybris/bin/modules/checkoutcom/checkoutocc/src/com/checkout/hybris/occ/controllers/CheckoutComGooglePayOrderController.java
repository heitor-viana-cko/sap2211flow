...
public class CheckoutComGooglePayOrderController {
    ...
    @Operation(operationId = "getMerchantConfiguration", description = "Gets google pay payment request")
    ...
    @Operation(operationId = "placeOrder", description = "Place a order with google pay.", summary = "Authorizes the cart and places the order. The response contains a place wallet order data.")
    ...
    @ResponseStatus(HttpStatus.CREATED)
    @ResponseBody
    @Operation(operationId = "getGooglePayDeliveryInfo", description = "Creates a delivery address and delivery method for the cart.")
    public GooglePayPaymentDataRequestUpdate getGooglePayDeliveryInfo(@Parameter(required = true) @RequestBody final GooglePayIntermediatePaymentData googlePayIntermediatePaymentData) throws DuplicateUidException {
