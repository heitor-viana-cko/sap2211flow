...
public class CheckoutComPaymentDetailsController {
    ...
    @Operation(operationId = "replacePaymentDetails", description = "Updates existing customer's credit card payment info.",
            summary =
    ...
    @Operation(operationId = "removePaymentDetails", description = "Deletes customer's credit card payment details.", summary = "Deletes a customer's credit card payment details based on a specified paymentDetailsId.")
    @ApiBaseSiteIdAndUserIdParam
    @ResponseStatus(HttpStatus.OK)
    @RequestMappingOverride
