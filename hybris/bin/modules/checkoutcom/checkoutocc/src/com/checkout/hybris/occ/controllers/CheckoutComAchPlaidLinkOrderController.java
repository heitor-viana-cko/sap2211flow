...
public class CheckoutComAchPlaidLinkOrderController {
    ...
    @Operation(operationId = "linkTokenCreate", description = "Gets the ACH link token")
    ...
    @Operation(operationId = "itemPublicTokenExchange", description = "Gets the ACH access token")
    @ApiBaseSiteIdUserIdAndCartIdParam
