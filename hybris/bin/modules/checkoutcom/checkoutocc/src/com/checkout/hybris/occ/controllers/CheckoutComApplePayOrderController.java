...
public class CheckoutComApplePayOrderController {
    ...
    @Operation(operationId = "getPaymentRequest", description = "Gets apple pay payment request")
    ...
    @Operation(operationId = "requestSession", description = "Validates the session for apple pay")
    ...
    @Operation(operationId = "placeOrder", description = "Place a order with apple pay.", summary = "Authorizes the cart and places the order. The response contains a place wallet order data.")
    ...
    @ResponseBody
    @Operation(operationId = "setDeliveryMethodOnCart", description = "Sets the deliveryMode for the cart.")
    public ApplePayShippingMethodUpdate setDeliveryMode(@Parameter(required = true) @RequestBody final ApplePayShippingMethod applePayShippingMethod) {
    ...
    @ResponseBody
    @Operation(operationId = "setDeliveryAddress", description = "Creates a delivery address for the cart.")
    public ApplePayShippingContactUpdate setDeliveryAddress(@Parameter(required = true) @RequestBody final ApplePayPaymentContact applePayPaymentContact) throws DuplicateUidException {
