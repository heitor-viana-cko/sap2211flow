...
public interface CheckoutComPaymentResponseStrategy {
     ...
     *
     * @param paymentResponse the request payment response from checkout.com
     * @param paymentInfo            the payment info
     * @return a {@link AuthorizeResponse}
     */
    AuthorizeResponse handlePendingPaymentResponse(PaymentResponse paymentResponse, PaymentInfoModel paymentInfo);
}
