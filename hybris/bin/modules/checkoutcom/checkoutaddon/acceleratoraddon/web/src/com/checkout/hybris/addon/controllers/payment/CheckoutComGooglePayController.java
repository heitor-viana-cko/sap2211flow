...
public class CheckoutComGooglePayController {
    ...
    public GooglePayPaymentDataRequestUpdate getGooglePayDeliveryInfo(final HttpServletRequest request,
                                                                      ...
                                                                      @Parameter(required = true) @RequestBody final GooglePayIntermediatePaymentData googlePayIntermediatePaymentData) throws DuplicateUidException {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    @ResponseBody
    @Operation(operationId = "clearCurrentCartAndAddToCart", description = "Removes current cart and add the product to a new cart")
