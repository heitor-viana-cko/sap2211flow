...
public class CheckoutComApplePayController {
    ...
    public ApplePayShippingContactUpdate setDeliveryAddress(final HttpServletRequest request, final HttpServletResponse response, @Parameter(required = true) @RequestBody final ApplePayPaymentContact applePayPaymentContact) throws DuplicateUidException {
