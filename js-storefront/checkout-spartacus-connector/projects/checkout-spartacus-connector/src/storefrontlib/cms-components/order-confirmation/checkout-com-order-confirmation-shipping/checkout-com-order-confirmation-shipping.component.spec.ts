...
import { Card, OutletContextData, OutletModule, PromotionsModule, } from '@spartacus/storefront';
import { of } from 'rxjs';
import { CheckoutComOrderConfirmationShippingComponent } from './checkout-com-order-confirmation-shipping.component';
...
describe('CheckoutComOrderConfirmationShippingComponent', () => {
  let component: CheckoutComOrderConfirmationShippingComponent;
  let fixture: ComponentFixture<CheckoutComOrderConfirmationShippingComponent>;

  function configureTestingModule(): TestBed {
    return TestBed.configureTestingModule({
      schemas: [CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA],
      imports: [I18nTestingModule, PromotionsModule, OutletModule],
      declarations: [CheckoutComOrderConfirmationShippingComponent, MockCardComponent],
      providers: [{
        provide: OrderFacade,
  ...
  function stubSeviceAndCreateComponent() {
    fixture = TestBed.createComponent(CheckoutComOrderConfirmationShippingComponent);
