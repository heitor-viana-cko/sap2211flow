...
import { MockCxOutletDirective } from '@checkout-tests/directives';
...
import { FeatureConfigService, I18nTestingModule, UserIdService, } from '@spartacus/core';
import { OutletContextData, PromotionsModule } from '@spartacus/storefront';
import { Observable, of, Subject } from 'rxjs';
import { CheckoutComCartItemListComponent } from './checkout-com-cart-item-list.component';
...
describe('CheckoutComCartItemListComponent', () => {
  let component: CheckoutComCartItemListComponent;
  let fixture: ComponentFixture<CheckoutComCartItemListComponent>;
  ...
  function configureTestingModule(): TestBed {
    return TestBed.configureTestingModule({
      ...
      declarations: [CheckoutComCartItemListComponent, MockCartItemComponent, MockCxOutletDirective],
      providers: [
        {
  ...
  function stubSeviceAndCreateComponent() {
    fixture = TestBed.createComponent(CheckoutComCartItemListComponent);
