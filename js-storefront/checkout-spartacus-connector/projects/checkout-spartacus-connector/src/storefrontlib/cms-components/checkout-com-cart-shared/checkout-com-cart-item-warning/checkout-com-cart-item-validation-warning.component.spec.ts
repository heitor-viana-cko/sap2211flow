...
describe('CheckoutComCartItemValidationWarningComponent', () => {
  let component: CheckoutComCartItemValidationWarningComponent;
  let fixture: ComponentFixture<CheckoutComCartItemValidationWarningComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CheckoutComCartItemValidationWarningComponent);
