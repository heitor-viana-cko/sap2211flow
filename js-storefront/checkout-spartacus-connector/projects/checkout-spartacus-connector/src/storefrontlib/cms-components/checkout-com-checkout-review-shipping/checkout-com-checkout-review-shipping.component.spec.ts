...
import { CheckoutComCheckoutReviewShippingComponent } from '@checkout-components/checkout-com-checkout-review-shipping/checkout-com-checkout-review-shipping.component';
import {
...
import { Card, IconTestingModule, OutletModule } from '@spartacus/storefront';
...
describe('CheckoutComCheckoutReviewShippingComponent', () => {
  let component: CheckoutComCheckoutReviewShippingComponent;
  let fixture: ComponentFixture<CheckoutComCheckoutReviewShippingComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [
        CheckoutComCheckoutReviewShippingComponent,
        MockUrlPipe,
        MockCardComponent,
      ],
      providers: [
    ...
    fixture = TestBed.createComponent(CheckoutComCheckoutReviewShippingComponent);
